...
// "ammo"      - ammo under pumping heart in upper right corner
...
void ScreenElementHUD::UpdateHealth(uint32 newHealth)
{
    if (newHealth > 100)
    {
        LOG_WARNING("Health was to be updated to: " + ToStr(newHealth) + ". Clamping to 100. This should be handled by logic before it got here !");
        newHealth = 100;
    }
